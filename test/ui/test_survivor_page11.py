...
from locators.locators_survivor_page11 import Survivor_page11


@allure.title('тесты сурвов')
def test_survivor(web_browser):
    page = Survivor_page11(web_browser)
    time.sleep(2)
    ...
    elements = [
        (page.btn_matador, 'Matador', '//idv.163.com/en/character/survivors/20260123/35290_1283385.html'),
    ]
